...
def build_graph() -> CompiledStateGraph:
    ...
    g.add_conditional_edges("crag_evaluator", route_crag, {
        "doctor_referral": "doctor_referral",
        "llm_generate": "llm_generate",
    })

    g.add_conditional_edges("selfrag_verifier", route_selfrag, {
        "memory_checkpoint": "memory_checkpoint",
        "partial_rewrite": "partial_rewrite",
        "safety_disclaimer": "safety_disclaimer",
    })

    g.add_conditional_edges("partial_rewrite", route_partial, {
