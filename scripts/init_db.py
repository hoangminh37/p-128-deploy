...
from src.models.domain import Article, Base, LearningPath, Patient, User
...
async def init_db(reset: bool = False):
    ...
    async with async_session_maker() as session:
        ...
        # Không seed hàng đợi hay log của biên tập viên. Hai bảng này phải phản
        # ánh dữ liệu vận hành thật: tài liệu BTV tải lên và nhu cầu chưa được
        # thư viện đáp ứng, không phải fixture để làm đẹp dashboard.
